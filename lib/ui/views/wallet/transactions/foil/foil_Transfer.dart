...
import 'foil_ConfirmTx.dart';
import 'model.dart';

class FOILTransferScreen extends StatelessWidget {
  WalletBalance balance;
  int accountFrom;
  FOILTransferScreen(this.balance, this.accountFrom, {Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BaseView<FOILTransferModel>(
      onModelReady: (model) async {
        ...
        model.foilBalance = model.account.coinBalances
            .firstWhere((b) => b.token.symbol == 'Foil');
        model.init();
      },
      builder: (context, model, child) {
        return ChangeNotifierProvider.value(
            ...
            child: Consumer<AccountManager>(builder: (_, __, ___) {
              ...
              model.balance = balance;
              print("model.foilBalance.toString(), ${model.foilBalance}");
              model.foilBalance = model.account.coinBalances
                  .firstWhere((b) => b.token.symbol == 'Foil');
